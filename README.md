...
| Skill | Does | Details |
|---|---|---|
| `fusion-runner-setup` | Guides Broadcom downloads and Windows installation, records boot-prompt gotchas and each setup stage, distinguishes a preserved baseline from the working runner, and compares CI with GitHub-hosted Windows. | [docs/skills/fusion-runner-setup.md](docs/skills/fusion-runner-setup.md) |
