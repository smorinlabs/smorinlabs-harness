...
| Wrong presentation form | Repeated dimensions or parallel decisions are encoded in prose. | Use a table for repeated comparison; a fixed template for repeated decisions. | Three group comparisons become <code>Group &#124; Changes &#124; Holds constant</code>. |
